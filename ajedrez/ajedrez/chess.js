...
function Colorear() {
    ...
    color.forEach(color => {
        ...
        a = aside + aup
        if (a % 2 == 0) {
            color.style.backgroundColor = '#aba7fc'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = '#0d0869'
        }
    })
}
Colorear()
function pawnMoved(){
    ...
    let pawnId = `${toggle}pawn`;
}
//para no eliminarte fichas a ti mismo
function reddish() {
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                if (i2.style.backgroundColor == 'green' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 == 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = '#aef7ae'
                    }
                    if (a % 2 !== 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = '#aef7ae'
                    }
...
document.querySelectorAll('.box').forEach(item => {
    item.addEventListener('click', function () {
        ...
        // para mostrar los movimientos posibles
            ...
            if (item.innerText == `${toggle}pawn`) {                
                ...
                contadorPawn++;      
                    ...
                    if (tog % 2 !== 0 && aup < 800) {
                        ...
                        if (aside > 1 && document.getElementById(`b${a + 200 - 1}`).innerText.length !== 0) {
                            document.getElementById(`b${a + 100 - 1}`).style.backgroundColor = 'green'
        ...
        // Cambio de turno
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "BLANCAS"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "NEGRAS"
            whosTurn('B')
        }
        reddish()
...
// Previene de seleccionar multiples fichas
z = 0
